...
**环境**：Python 3.9+（推荐 3.10+）；已含 `eval_type_backport` 便于在 3.9 下运行。  
**前端接口文档**：[docs/FRONTEND_API.md](docs/FRONTEND_API.md)。启动后端后也可打开 `http://127.0.0.1:8011/docs`。  
**小白步骤**：见根目录 **第一次使用-只看这个.txt**。
